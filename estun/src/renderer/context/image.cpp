...
estun::Image::Image(Image &&other) noexcept
    : width_(other.width_),
...
estun::DeviceMemory estun::Image::AllocateMemory(const VkMemoryPropertyFlags properties) const
{
...
VkMemoryRequirements estun::Image::GetMemoryRequirements() const
{
...
void estun::Image::GenerateMipmaps()
{
...
VkImage estun::Image::GetImage() const
{
    return image;
}

uint32_t estun::Image::GetWidth()
{
    return width_;
}

uint32_t estun::Image::GetHeight()
{
    return height_;
}

VkFormat estun::Image::GetFormat()
{
    return format_;
}

VkImageLayout estun::Image::GetLayout()
{
    return layout_;
}
