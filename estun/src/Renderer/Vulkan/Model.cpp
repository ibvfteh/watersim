...
Estun::Renderer::Vulkan::Model Estun::Renderer::Vulkan::Model::LoadModel(const std::string &filename)
{
...
Estun::Renderer::Vulkan::Model Estun::Renderer::Vulkan::Model::CreateBox(const glm::vec3 &p0, const glm::vec3 &p1, const Material &material)
{
    std::vector<Vertex> vertices =
        {
...
Estun::Renderer::Vulkan::Model Estun::Renderer::Vulkan::Model::CreateSphere(const glm::vec3 &center, float radius, const Material &material)
{
    const int slices = 32;
    const int stacks = 16;
...
void Estun::Renderer::Vulkan::Model::SetMaterial(const Material &material)
{
...
void Estun::Renderer::Vulkan::Model::Transform(const glm::mat4 &transform)
{
...
Estun::Renderer::Vulkan::Model::Model(std::vector<Vertex> &&vertices, std::vector<uint32_t> &&indices, std::vector<Material> &&materials)
