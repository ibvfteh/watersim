...
Estun::Renderer::Vulkan::Semaphore::Semaphore() 
{
...
Estun::Renderer::Vulkan::Semaphore::Semaphore(Semaphore&& other) noexcept :
...
VkSemaphore Estun::Renderer::Vulkan::Semaphore::GetSemaphore() const
{
    return semaphore;
}
