...
Estun::Renderer::Vulkan::GraphicsPipeline::GraphicsPipeline(
...
void Estun::Renderer::Vulkan::GraphicsPipeline::Bind()
{
	vkCmdBindPipeline(ContextLocator::GetCurrentCommandBuffer(), VK_PIPELINE_BIND_POINT_GRAPHICS, pipeline);
}
