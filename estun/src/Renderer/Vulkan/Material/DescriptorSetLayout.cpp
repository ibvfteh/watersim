...
Estun::Renderer::Vulkan::DescriptorSetLayout::DescriptorSetLayout(const std::vector<DescriptorBinding> &descriptorBindings) 
{
...
Estun::Renderer::Vulkan::DescriptorSetLayout::~DescriptorSetLayout()
{
    if (layout != nullptr)
    {
...
VkDescriptorSetLayout Estun::Renderer::Vulkan::DescriptorSetLayout::GetLayout() const
{
    return layout;
}
