...
void estun::AccelerationStructureManager::Submit(
    ...
    bool allowUpdate)
{
    SingleTimeCommands::SubmitTransfer(CommandPoolLocator::GetTransferPool(), [this, models, vertexBuffer, indexBuffer, allowUpdate](VkCommandBuffer commandBuffer) {
        Buffer::BufferMemoryBarrier(commandBuffer, vertexBuffer->GetBuffer(), true);
        Buffer::BufferMemoryBarrier(commandBuffer, indexBuffer->GetBuffer(), true);
    });
    SingleTimeCommands::SubmitCompute(CommandPoolLocator::GetComputePool(), [this, models, vertexBuffer, indexBuffer, allowUpdate](VkCommandBuffer commandBuffer) {
        ...
        Buffer::BufferMemoryBarrier(commandBuffer, vertexBuffer->GetBuffer(), false);
        Buffer::BufferMemoryBarrier(commandBuffer, indexBuffer->GetBuffer(), false);
    });
    SingleTimeCommands::SubmitTransfer(CommandPoolLocator::GetTransferPool(), [this, models, vertexBuffer, indexBuffer, allowUpdate](VkCommandBuffer commandBuffer) {
        Buffer::BufferMemoryBarrier(commandBuffer, vertexBuffer->GetBuffer(), false);
        Buffer::BufferMemoryBarrier(commandBuffer, indexBuffer->GetBuffer(), false);
