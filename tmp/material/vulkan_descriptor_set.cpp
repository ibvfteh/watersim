#include "renderer/vulkan/material/vulkan_descriptor_set.h"
...
namespace estun
{
    ...
    VkPipelineLayout* VulkanDescriptorSet::GetPipelineLayout()
    {
	    return &pipelineLayout;
    }

    const std::vector<VkDescriptorSet>* VulkanDescriptorSet::GetDescriptorSets() const
    {
